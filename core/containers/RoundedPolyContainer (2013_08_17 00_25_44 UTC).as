...
class net.lost.core.containers.RoundedPolyContainer extends MovieClip{
	...
	private var rect:PolyObject,innerRect:PolyObject;
	...
	public function drawPaneShape(name){
		return  this.attachMovie("net.lost.core.shape.MCRect",name+"MC",this.getNextHighestDepth());
	}
	...
	public function getTheme(themeProvider){
		...
		var theme:PolyTheme=(themeProvider!=undefined)?themeProvider:new PolyTheme();
