 ...
 class com.abazaba.core.view.controls.Slider extends MovieClip
{
	...
	public function Slider(){
		...
		tf.addEventListener("onKillFocus",this)
	...
	// ---------------------------------------------------------------
	// @
	public function onKillFocus(e:Object){
		if(e.target.value!=undefined){__value=e.target.value}
	}
	...
	// @
	function enter(e){
		var value=validateValue(e.target.value);
		__value=value;
	}
